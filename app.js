...
console.log(x);
*/
// スコープのメリットとして　スコープさえ異なれば同じ名前を使い回して違う値を管理できるので開発の規模がある程度になってきたら使わざる追えなくなるらしい

//  #27 複数のスクリプトを読み込んでみよう

// {
//   // ここでローカルスコープを活用することで（ブロックの中に入れることで）エラーを回避できる
//   // 今後の講座では、全体をブロックで囲ってコーディングしていくとのこと
//   let x = 10;
//   console.log(x); //ローカルスコープによりsub.jsの影響を受けずにエラー回避ができている
// }
